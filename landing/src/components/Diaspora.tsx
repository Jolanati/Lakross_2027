  ...
  return (
    <section id="diaspora" className="pt-8 pb-12 md:pt-10 md:pb-16 px-6 bg-cream">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-charcoal/80 max-w-2xl mb-6 leading-relaxed">
        ...
        {/* Who we're reaching */}
        <div className="grid md:grid-cols-3 gap-px bg-charcoal/10 mb-6">
          {steps.map((s, i) => (
            <div key={i} className="bg-cream-light p-6">
              <div className="text-2xl mb-3">{s.flag}</div>
        ...
        {/* Pull quote */}
        <blockquote className="border-l-4 border-carmine pl-6 mb-6">
          <p className="text-lg md:text-xl font-display font-semibold text-charcoal leading-snug">
