...
export const lv = {
  ...
  nav: {
    ...
    team: 'Komanda',
    sponsors: 'Sponsoriem',
    modeAcademic: '🎓 Akadēmiskais',
    modeCampaign: '🚀 Kampaņa',
  },

  // -- Hero (ATTENTION) --
  hero: {
    overtitle: 'LATVIJAS SIEVIEŠU LAKROSA IZLASE',
    title: 'Mēs nesam Latvijas vārdu pasaulē',
    subtitle: 'Palīdzi mums iekļūt Eiropas Top 5 un spert pirmo soli uz Olimpiskajām spēlēm!',
    cta: 'Atbalsti mūs',
    scrollHint: 'Uzzini vairāk',
    badge: 'ROAD TO TOP 5',
  },
  ...
  // -- Timeline (ACADEMIC ONLY) --
  timeline: {
    overtitle: 'LAIKA GRAFIKS',
    title: 'Rīcības kalendārs: Jūnijs – Novembris 2026',
    months: [
      {
        month: 'Jūnijs',
  ...
  donate: {
    ...
    ctaMerch: 'Vai iegādājies atribūtiku',
    trust: 'Droši maksājumi caur Zeffy. 100% nonāk pie komandas.',
  },
